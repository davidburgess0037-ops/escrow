...
function Dashboard() {
  ...
  const [escrows, setEscrows] = useState([
    ...
    },
    {
      ...
      status: "Completed",
      date: "Aug 25, 2026",
      description: "Purchase of a laptop computer from the seller.",
    },
    {
      id: "ESC-1003",
      title: "Logo Design",
  ...
  const handleWalletAction = (e) => {
    ...
    // Wallet transactions require admin approval.
    // Balance is NOT changed here.
    setSuccessMessage(
      "Your request could not be completed. Please contact admin for assistance."
    );
  ...
  const createEscrow = (e) => {
    ...
    setSuccessMessage(
      `${formatMoney(amount)} has been successfully placed into escrow.`
    );
  ...
  const releaseFunds = (id) => {
    ...
    setSuccessMessage(
      `${formatMoney(escrow.amount)} has been successfully released.`
    );
  ...
  const cancelEscrow = (id) => {
    ...
    // Return escrow money to wallet
    setBalance((current) => current + escrow.amount);

    setSuccessMessage(
      `${formatMoney(escrow.amount)} has been returned to your wallet.`
    );
    ...
    <div className="min-h-screen bg-gray-100 text-gray-900 dark:bg-gray-950 dark:text-white">
        ...
        <section className="mb-8 flex flex-col justify-between gap-5 md:flex-row md:items-center">
          ...
          <div>
            ...
            <p className="mt-2 text-gray-500 dark:text-gray-400">
              Manage your wallet and escrow transactions.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button
              ...
              className="rounded-lg bg-green-600 px-6 py-3 font-bold text-white shadow-sm transition hover:bg-green-700"
            >
              + Add Funds
            </button>
            ...
            <button
              ...
              className="rounded-lg border border-red-500 px-6 py-3 font-bold text-red-600 transition hover:bg-red-50 dark:hover:bg-red-900/20"
            >
              Withdraw
            </button>
        ...
        <section className="mt-10">
          ...
          <div className="mb-5">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Add money or withdraw money from your available balance.
            </p>
          </div>
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            ...
            <button
              type="button"
              onClick={() => setWalletAction("add")}
              className="group rounded-xl border border-gray-200 bg-white p-6 text-left shadow-sm transition hover:-translate-y-1 hover:shadow-md dark:border-gray-800 dark:bg-gray-900"
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <div>
                  ...
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-green-100 text-2xl font-bold text-green-600 dark:bg-green-900/30">
                    +
                  </div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-gray-500 dark:text-gray-400">
                    Add money to your wallet and increase your available balance.
                  </p>

                </div>

                <span className="text-2xl text-gray-300 transition group-hover:text-green-600">
                  →
                </span>
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <div>
                  ...
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-red-100 text-2xl font-bold text-red-600 dark:bg-red-900/30">
                    ↓
                  </div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-gray-500 dark:text-gray-400">
                    Withdraw available money from your wallet.
                  </p>

                </div>

                <span className="text-2xl text-gray-300 transition group-hover:text-red-600">
                  →
                </span>
      ...
      {walletAction && (
        ...
        >
          ...
          <div
            className="relative z-[101] w-full max-w-md rounded-2xl bg-white p-6 text-gray-900 shadow-2xl dark:bg-gray-900 dark:text-white"
          ...
          >
            ...
            <div className="flex items-start justify-between">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                  {walletAction === "add"
                    ...
                    : "Withdraw money from your available wallet balance."}
                </p>
              ...
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full bg-gray-100 text-xl text-gray-600 hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-300"
              >
                ×
              </button>
            ...
            >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className="w-full rounded-lg border border-gray-300 bg-white py-3 pl-10 pr-4 text-gray-900 outline-none transition placeholder:text-gray-400 focus:border-adainyellow focus:ring-2 focus:ring-orange-100 dark:border-gray-700 dark:bg-gray-800 dark:text-white"
                    required
                  />
              ...
              <div className="flex gap-3">
                ...
                <button
                  type="submit"
                  className={`flex-1 rounded-lg px-4 py-3 font-bold text-white transition ${
                    walletAction === "add"
      ...
      {showSuccessModal && (
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/70 px-4">
          ...
          <div className="w-full max-w-sm rounded-2xl bg-white p-7 text-center shadow-2xl dark:bg-gray-900">

            {/* FAILED ICON */}

            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-red-100 text-3xl font-bold text-red-600 dark:bg-red-900/30">
              ✕
            </div>
            ...
            <button
              ...
              className="mt-6 w-full rounded-lg bg-red-600 px-4 py-3 font-bold text-white transition hover:bg-red-700"
            >
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-gray-900 outline-none transition placeholder:text-gray-400 focus:border-adainyellow focus:ring-2 focus:ring-orange-100 dark:border-gray-700 dark:bg-gray-800 dark:text-white"
                  required
                />
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-lg border border-gray-300 bg-white px-4 py-3 text-gray-900 outline-none transition placeholder:text-gray-400 focus:border-adainyellow focus:ring-2 focus:ring-orange-100 dark:border-gray-700 dark:bg-gray-800 dark:text-white"
                />
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs leading-5 text-orange-700 dark:text-orange-400">
                      The transaction should only be completed and funds released according to the agreed transaction terms.
                    </p>
    ...
    <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="min-w-0 flex-1 pr-3">
          ...
          <h3
            className={`mt-2 max-w-full break-all font-bold ${valueClassName}`}
          >
            {value}
          </h3>
        ...
        <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-orange-100 font-bold text-adainyellow dark:bg-orange-900/30">
          {icon}
        </div>
